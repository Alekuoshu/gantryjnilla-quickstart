...
?>
<?php echo JLayoutHelper::render('jnilla.layout.render_system_messages', array('group' => 'jn-main')); ?>
	...
	<div class="container">
		<div class="jn-row-fluid">
			<div class="jn-span-<?php echo $fparams->schema['mb']; ?> <?php echo $fparams->pushPull[0]; ?>">
				<?php echo JLayoutHelper::render('jnilla.layout.render_group', array('group' => 'jn-above', 'noContainer' => true)); ?>
				<?php if ($display_component && ($option != "com_blankcomponent")) : ?>
					<div class="jn-block component-content">
						<jdoc:include type="component" />
					</div>
				<?php endif; ?>
				<?php echo JLayoutHelper::render('jnilla.layout.render_group', array('group' => 'jn-below', 'noContainer' => true)); ?>
			</div>
