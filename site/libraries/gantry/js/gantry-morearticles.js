...
this.button.addClass("disabled");}g.inject(this.wrapper,this.wrapper.hasClass("rt-leading-articles")?"inside":"after");if(typeof GantryBuildSpans=="function"){var j=["jn-block"];
