...
class GantryFeatureStyleDeclaration extends GantryFeature
{
	...
	function init()
	{
		...
		$css .= '#rt-header .container {background:' . $gantry->get('headercolor') . ';}';
		$css .= '#rt-bottom .container {background:' . $gantry->get('bottomcolor') . ';}';
		$css .= '#rt-footer .container, #rt-copyright .container, #rt-menu .container {background:' . $gantry->get('footercolor') . ';}';
